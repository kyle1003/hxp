								...
								<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
									...
									<tr align="center">
										<td height="20" valign="top" nowrap>
											<div align="right"><a href="xiangmujihua.ftl" onclick="">创建项目计划</a></div></td>
										<td valign="top"><div align="right"><a href="xiangmuxuqiu.ftl">创建项目需求</a></div></td>
										<td valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
									</tr>
									<tr align="center">
										<td height="20" valign="top" nowrap><div align="right"><a href="xiangmumokuai.ftl" onclick="">创建项目模块</a></div></td>
										<td valign="top"><div align="right"><a href="xiangmugongnen.ftl">创建项目功能</a></div></td>
										<td valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
									</tr>
									<tr align="center">
										<td height="20" valign="top" nowrap>
											<div align="right">
												<a href="xiangmuwenjian.ftl">上传项目文件</a></div></td>
										<td valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
										<td valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
									</tr>
									<tr align="center">
