...
public class VerifyImage extends HttpServlet {
	...
	// 验证码出现的字符
	private static char[] captchars = new char[] { '1', '2', '3', '4', '5', '6', '7', '8', '9' };
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getSession(true).setAttribute(VerifyImage.SIMPLE_CAPCHA_SESSION_KEY, test);// 将字符串写入session
		...
		// TextLayout textTl = new TextLayout(test, new Font("Fixedsys", Font.PLAIN, 20), new FontRenderContext(null, true, false));// 获得字体一样的字，20是字体的大小
		...
		// this.drawThickLine(graphics, 0, random.nextInt(ImageHeight) + 1, ImageWidth, random.nextInt(ImageHeight) + 1, 4, getRandColor(100, 200));// 加一道线
