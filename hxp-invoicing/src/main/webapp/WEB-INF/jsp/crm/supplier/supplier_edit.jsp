        ...
        <div class="fieldset-body">
            <table class="form-table" border="0" style="width: 100%" cellpadding="1" cellspacing="2">
                <tr>
                    ...
                    <td>
                        <input name="name" value="${info.name}" class="mini-textbox" required="true" requiredErrorText="姓名不能为空"/>
                    </td>
                    <td class="form-label"   align="right">联系电话：</td>
                    <td>
                        <input name="phone"   value="${info.phone}" class="mini-textbox" required="true" requiredErrorText="联系电话不能为空"/>
                    </td>
                </tr>
                <tr>
                    <td class="form-label" style="width:100px;" align="right">地址：</td>
                    <td>
                        <input name="address" value="${info.address}"  class="mini-textbox"/>
                    </td>
                    <td class="form-label"   align="right">备注</td>
                    <td>
                        <input name="remark" value="${info.remark}" class="mini-textarea"/>
                    </td>
                </tr>
                <tr >
...
<script type="text/javascript">
		...
		function doSave(){
			...
			doAjax("<%=basePath%>supplier_info_edit.do",{json:json,t:new Date().getTime()},"POST",function(r,s){
