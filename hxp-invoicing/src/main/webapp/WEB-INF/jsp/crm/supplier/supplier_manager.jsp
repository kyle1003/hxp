...
<!--工具栏-->
	<div class="mini-toolbar" style="padding:2px;border:0;" id="searchForm" >
			<a class="mini-button" iconCls="icon-add" plain="true" onclick="add()">新增供应商</a>
			<a class="mini-button" iconCls="icon-edit" plain="true" onclick="edit()">编辑供应商</a>
			<span class="separator"></span>
			<a class="mini-button" iconCls="icon-reload" plain="true" onclick="grid.reload();">刷新</a>
			<a class="mini-button" iconCls="icon-print" plain="true" onclick="exportExcel(grid,'供应商列表')">导出EXCEL</a>
	...
	<div class="mini-fit" style="height:100px;" align="center">
	 	<div id="datagrid1" class="mini-datagrid" onrowdblclick="edit" pageSize="50"  url="<%=basePath %>supplier_list_json.do" style="width: 100%; height: 100%" showColumnsMenu="true" allowAlternating="true" allowCellSelect="true" multiSelect="true"   editNextOnEnterKey="true"  editNextRowCell="true" allowCellEdit="true"  showfooter="false" contextMenu="#gridMenu" >
	        <div property="columns">
	            <div field="id" name="rowid" width="50" align="center" headeralign="center" allowSort="true">序号</div>
	            <div field="name" align="center" headeralign="center" width="160" allowSort="true">供应商名</div>
	 ...
	 <ul id="gridMenu" class="mini-contextmenu" onbeforeopen="onBeforeOpen">              
        <li iconCls="icon-add" onclick="add">新增供应商</li>
	    <li iconCls="icon-edit" onclick="edit">编辑供应商</li>
   	 </ul>
</body>
...
<script type="text/javascript">
		...
		function add(){
			openWindow("<%=basePath%>jsp/crm/supplier/supplier_add.jsp","添加供应商",650,500,function(){
				grid.reload();
			});
		}
		...
		function edit(){
			...
			openWindow("<%=basePath%>supplier_info_edit_page.do?id="+row.id,"修改供应商",650,500,function(){
				grid.reload();
			});
		}
