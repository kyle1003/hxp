...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div id="editForm1" style="padding:5px;">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="width:150px;" colspan="2"><input name="discription"  id="discription" class="mini-textbox" /></td>
                </tr>
            </table>
        </div>
    </fieldset>
  ...
  <br/>
    ...
    <br/>
    <div align="center">
    	<a class="mini-button" onclick="doAdd()">提交</a>
    </div>
  </body>
...
<script type="text/javascript">
		...
		function doAdd(){
			...
			var discription=mini.get("discription").getValue();
			 $.ajax({
					type:"post", //请求方式
					url:"<%=basePath%>managerGroup_doSave.do",
					data : { //发送给后台的数据
