...
<!--Layout-->
	    ...
	    <div class="mini-fit" style="height:100px;" align="center">
	        <div id="datagrid" class="mini-datagrid" showFooter="false" style="width:100%;height:100%;"  url="<%=basePath%>order_list_json.do"  idField="id" sizeList="[5,10,20,50]" pageSize="10" contextMenu="#gridMenu" headerContextMenu="#headerMenu">
	            <div property="columns">
	                ...
	                <div field="createDate" width="80" headerAlign="center" allowSort="true">开单日期</div>
	                ...
	                <div field="status" width="80" headerAlign="center" allowSort="false">状态</div>
	            </div>
	        </div> 
	    </div>
    ...
    <script type="text/javascript">
		...
		grid.load({key:"type=<%=Order.TYPE_SELL_ORDER%>,status=<%=Order.STATUS_NOTCHECKED%>"});
		...
		function search(){
			...
			if(keyobj.value!=""){
				grid.load({key:"type=<%=Order.TYPE_SELL_ORDER%>,status=<%=Order.STATUS_NOTCHECKED%>,id="+keyobj.value});
			}
		}
