       ...
       <div class="mini-toolbar" style="padding:2px;border:0;">
	        <table style="width:100%;">
	            ...
	            <td style="width:100%;">
	            	...
	            	<label style="display: none;">收银员:<input class="mini-combobox" onvaluechanged="search()" style="width: 80px" id="user" value="${sessionScope.user.id }" showNullItem="true" url="<%=basePath %>user_combobox.do?type=<%=JSON.TYPE_COMBOBOX %>" valueField="id" textFiled="text" />
	            	</label>
