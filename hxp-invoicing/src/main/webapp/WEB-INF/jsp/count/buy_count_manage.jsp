...
<!--Layout-->
       <div class="mini-toolbar" style="padding:2px;border:0;">
	    ...
	    <div class="mini-fit" style="height:100px;" align="center">
	        <div id="datagrid" class="mini-datagrid"  onrowdblclick="info()" showFooter="true" style="width:100%;height:100%;"  url="<%=basePath%>order_list_json.do"  idField="id" sizeList="[5,10,20,50,100,300]" pageSize="20" >
    ...
    <script type="text/javascript">
		...
		function info(){
			...
			openWindow("<%=basePath%>order_info.do?id="+d.id+"&type="+type,"单据明细",750,500)
		}
		
		function edit(){
			var d = grid.getSelected();
			if(!d||d.id=="合计"){mini.alert("请选择"); return;}
			openWindow("<%=basePath%>order_info.do?type=edit&id="+d.id+"&type="+type,"单据编辑",550,500)
		}
		
		function searchCost(){
			openWindow("<%=basePath%>jsp/count/cost_info.jsp?&type="+type,"成本",550,500)
		}
    </script>
